...
const Newslots4 = () => {
  ...
  const data2 = [
            ...
            ["區間快/延長嘉義始發", "2008", "北上", "嘉義-基隆", "預估嘉義發車時間 04:45", "預估抵達田中時間05:32"],
            ...
            ["區間車/加開", "2207", "南下", "台中-田中", "台中發車時間04:20", "抵達田中時間05:12"],
  ...
  return (
      <div className="back2">
            ...
            <div className="news">2024田中馬拉松賽事公告-臺鐵加班車最新資訊</div>
            
      <div className="content" style={{ marginBottom: '20px' }}>
      親愛的2024田中馬拉松選手您好，綠色賽事的路上有您有我，今年度大會向臺鐵爭取加開班次，感謝臺鐵公司配合於11月10日加開及增停相關班次(2207、3137、2008及172次增停田中站)。            </div>

            <div className="content" style={{ marginBottom: '20px' }}>
            針對自行開車前往之選手，亦可停車至加開班車沿線停靠之車站停車，搭乘加開班車前往會場，臺鐵田中站距離活動會場步行15分鐘即可抵達，敬請多加利用。
            </div>
            <div className="content" style={{ marginBottom: '20px' }}>
            以下為今年臺鐵班次資訊提供選手參考：
            </div>
      ...
      <div className="content" style={{ marginBottom: '20px' }}>
      北上172 潮州-花蓮，自強號，增停田中站預估13:06發車。
            </div>
            <div className="content" style={{ marginBottom: '20px' }}>
            更多班次資訊請參考臺鐵公司網站：
